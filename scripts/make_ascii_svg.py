...
# crop box (left, top, right, bottom) in source-prepped.png pixel coords, applied
# before the resize to COLS x ROWS -- keeps a tall portrait photo from being
# squashed into the near-square ascii grid. None = use the full image.
CROP_BOX = (0, 200, 1290, 1481)
